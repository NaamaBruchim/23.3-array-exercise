...
// 	a- do they contain only numbers?
// 	b- do they contain only truthy values?
// 	c- do they have an elemnt with the value 3?
// 	d- do they have an element with a value less than 0?
// 	e- find the first string value with 5 letters
// 	f- find all string values with 5 letters
// 	g- find only numeric values and multiply by 3
// [23,5,6,22,"a", true,3,5,7,3, "hello", "daniel"]
// [3,4,5,6,0, 7]
// [true, {}, []]

const someArr = [23, 5, 6, 22, "a", true, 3, 5, 7, 3, "hello", "daniel"];
const numbers = [3, 4, 5, 6, 0, 7];
const objects = [true, {},
    []
];

function question_2a() {
    console.log(someArr.every((x) => typeof x === "number"));
    console.log(numbers.every((x) => typeof x === "number"));
    console.log(objects.every((x) => typeof x === "number"));
}
question_2a();

function question_2b() {
    console.log(someArr.every((x) => Boolean(x)));
    console.log(numbers.every((x) => Boolean(x)));
    console.log(objects.every((x) => Boolean(x)));
}
question_2b();

function question_2c() {
    console.log(someArr.some((x) => x === 3));
    console.log(numbers.some((x) => x === 3));
    console.log(objects.some((x) => x === 3));
}
question_2c();

function question_2d() {
    console.log(someArr.some((x) => x < 0));
    console.log(numbers.some((x) => x < 0));
    console.log(objects.some((x) => x < 0));
}
question_2d();
...
function question_2e() {
    console.log(someArr.find((x) => x.length === 5));
    console.log(numbers.find((x) => x.length === 5));
    console.log(objects.find((x) => x.length === 5));
}
question_2e();

function question_2f() {
    console.log(someArr.filter((x) => x.length === 5));
    console.log(numbers.filter((x) => x.length === 5));
    console.log(objects.filter((x) => x.length === 5));
}
question_2f();


function question_2g() {
    console.log(someArr.map((x) => x * 3));
    console.log(numbers.map((x) => x * 3));
    console.log(objects.map((x) => x * 3));
}
question_2g();
...
// 	a - find only males
// 	b - sort all users by name
// 	c - sort all users by age
// 	d - sort all users by isActive
// 	e - find only users over 18
// 	f - are some of the users with green eyes?
// 	g - create array only with the users names
// 	h - create an array with all the original data and two more properties "numberOfFriends" and "numberOfTags"
...
function question3Sort(comparerField) {
    console.log(`compare Users by: ${comparerField}`);
    console.log(users.sort((userA, userB) => compareUsers(userA, userB, comparerField)));
}

function compareUsers(userA, userB, comparerField) {
    if (userA[comparerField] < userB[comparerField]) {
        return -1;
    }
    if (userA[comparerField] > userB[comparerField]) {
        return 1;
...
function question3f() {
    console.log(users.some((user) => user.eyeColor === "green"));
}
question3f();
...
function question3gg() {
    console.log(users.map((user) => user.name + " is " + user.gender));
}
...
function question3i() {
    console.log(users.filter((user) => user.age > 22)
        .sort((userA, userB) => compareUsers(userA, userB, "name"))
        .map((user) => `welcome, ${user.name} (${user.age})`));
}
